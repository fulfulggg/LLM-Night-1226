  ...
  return (
    <>
      <div className={`feature-card311-feature-card ${props.rootClassName} `}>
        <svg viewBox="0 0 1024 1024" className="feature-card311-icon">
        ...
        <span className="feature-card311-text1">{props.description}</span>
      </div>
      <style jsx>
        {`
          ...
          .feature-card311-icon {
            fill: var(--dl-color-gray-500);
            width: var(--dl-size-size-small);
            height: var(--dl-size-size-small);
          }
          .feature-card311-text {
            font-style: normal;
